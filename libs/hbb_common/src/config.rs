...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("AmjDesk".to_owned());
...
pub const LINK_HEADLESS_LINUX_SUPPORT: &str =
    "https://github.com/accamj/amjdesk/wiki/Headless-Linux-Support";
lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("amjdesk docs home", LINK_DOCS_HOME),
        ("amjdesk docs x11-required", LINK_DOCS_X11_REQUIRED),
        ("amjdesk x11 headless", LINK_HEADLESS_LINUX_SUPPORT),
        ]);
}
