...
///
/// Note:
/// On linux, we use dbus to communicate multiple amjdesk process.
...
const DBUS_NAME: &str = "org.amjdesk.amjdesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "AmjDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.amjdesk.amjdesk /dbus org.amjdesk.amjdesk.NewConnection string:'PEER_ID'`
